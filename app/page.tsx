...
export default function Home() {
  ...
  return (
    <main>
      <nav className="nav"><button className="brand" onClick={() => setStep("landing")}><span>너를</span> 알아가는 과정</button><div className="nav-right"><span className="price">1회 500원</span><span className="secure">🔒 안전 결제</span></div></nav>
